...
def main():
    ...
    if args.test:
        ...
        args.log_path = './logs_test_finetune'
        ...
        for i in range(1):
            ...
            avg_reward,eval_episode_steps = run_eval_episodes(agent,env,1,writer=writer)
        ...
        while train_num < args.max_train_num:
            ...
            student_avg_reward,student_eval_episode_steps = run_eval_episodes(agent,env,EVAL_EPISODES)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--log_path',default='./logs_actor_critic_finetune',type=str
    )
    parser.add_argument(
